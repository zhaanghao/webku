...
<div id="post-<?php the_ID(); ?>" <?php post_class('post-single mb-4'); ?>>
  <?php if ( has_post_thumbnail() && get_theme_mod( 'fast_food_delivery_single_post_featured_image',true) ) { ?>
    <div class="post-thumbnail post-img">
      <?php the_post_thumbnail(''); ?>
    </div>
  <?php }?>
  <div class="post-info my-2">
    <?php if( get_theme_mod( 'fast_food_delivery_single_post_date_hide',true)) : ?>
    ...
    <?php endif; ?>
    <?php if( get_theme_mod( 'fast_food_delivery_single_post_author_hide',true)) : ?>
    ...
    <?php endif; ?>
    <?php if( get_theme_mod( 'fast_food_delivery_single_post_comment_hide',true)) : ?>
  ...
  <div class="post-content">
    <?php the_content(); ?>
    <?php if( get_theme_mod( 'fast_food_delivery_single_post_tag',true)) : ?>
      <?php the_tags('<div class="post-tags"><strong>'.esc_html__('Tags:','fast-food-delivery').'</strong> ', ', ', '</div>');?>
    <?php endif; ?>
    <?php if( get_theme_mod( 'fast_food_delivery_single_post_category',true)) : ?>
      <div class="single-post-category mt-3">
    		<span class="category"><?php esc_html_e('Categories:','fast-food-delivery'); ?></span>
    			<?php the_category(); ?>
    	</div>
    <?php endif; ?>
  </div>
